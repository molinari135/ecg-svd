...
if __name__ == "__main__":
    df_comparison = consolidate_all_reports("r01.edf")
    print(df_comparison.sort_values(by="accuracy", ascending=False))
    df_comparison = consolidate_all_reports("r04.edf")
    print(df_comparison.sort_values(by="accuracy", ascending=False))
    df_comparison = consolidate_all_reports("r07.edf")
    print(df_comparison.sort_values(by="accuracy", ascending=False))
    df_comparison = consolidate_all_reports("r08.edf")
    print(df_comparison.sort_values(by="accuracy", ascending=False))
    df_comparison = consolidate_all_reports("r10.edf")
    print(df_comparison.sort_values(by="accuracy", ascending=False))
